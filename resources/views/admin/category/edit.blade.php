    ...
    <main>
        ...
        <div class="row">
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form class="needs-validation" action="{{route('admin.category.edit.post', ['id'=>$data[0]['id']])}}"
                      method="POST" novalidate>
                    {{csrf_field()}}
                    <div class="row g-3">
                        <div class="col-sm-6">
                            <label for="title" class="form-label">Kategori Adı</label>
                            <input type="text" name="name" class="form-control" id="title" placeholder="Kategori Adı"
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="topCategory" class="form-select" id="category" required>
                                ...
                                @foreach($category as $key => $value)
                                    <option @if($value['id'] == $data[0]['topCategory']) selected
                    ...
                    <button class="w-100 btn btn-primary btn-lg" type="submit">Kategoriyi Güncelle!</button>
                </form>
            </div>
        </div>
    </main>
